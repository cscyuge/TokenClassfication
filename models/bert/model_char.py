...
def build(hidden_size, batch_size, cuda):
    ...
    train_data = build_dataset(config, './data/train/src_ids_char_0.pkl', './data/train/src_masks_char_0.pkl',
                               './data/train/tar_masks_char_0.pkl')
    test_data = build_dataset(config, './data/test/src_ids_char_0.pkl', './data/test/src_masks_char_0.pkl',
                              './data/test/tar_masks_char_0.pkl')
    val_data = build_dataset(config, './data/valid/src_ids_char_0.pkl', './data/valid/src_masks_char_0.pkl',
                             './data/valid/tar_masks_char_0.pkl')
